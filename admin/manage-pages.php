...
<head>
	...
	<title> Auto Trader | Admin Manage Pages</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php?type=aboutus">About Us Page</option>
									<option value="manage-pages.php?type=finance">Finance Page</option>
									<option value="manage-pages.php?type=warranty">Warranty Page</option>
                </select>
												</div>
											</div>
